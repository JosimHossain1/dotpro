    ...
    <section id="checkout" className="py-40 px-6 bg-white dark:bg-[#0A0A0A] border-t border-black/5 dark:border-white/5 transition-colors duration-500">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
           <div className="relative group bg-[#0A0A0A] dark:bg-white/2 border dark:border-white/10 rounded-[4rem] p-12 md:p-20 text-center overflow-hidden shadow-2xl transition-all hover:shadow-[#00CC76]/10">
              {/* Subtle Shimmer */}
              ...
              <div className="relative z-10 flex flex-col items-center">
                 <div className="mb-10 inline-flex items-center space-x-3 bg-white/5 border border-white/10 px-6 py-2 rounded-full">
                    <span className="text-[#00CC76] font-black text-[10px] tracking-[0.3em] uppercase">Limited Release v1.0.0</span>
                 </div>
                 ...
                 <div className="mt-16 pt-10 border-t border-white/5 w-full flex flex-wrap justify-center gap-12 opacity-50">
