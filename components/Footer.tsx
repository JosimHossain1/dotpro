...
const Footer = () => {
  return (
    <footer
      ...
      className="relative z-10 bg-[#f8f8f82d] dark:bg-[#1b1b1b] transition-colors duration-500"
    >
      <div className="max-w-6xl mx-auto pt-15 px-6 md:px-0 ">
        {/* Top Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 mb-10">
          {/* Brand */}
          <div>
           <Logo/>
            <p className=" font-semibold text-black/60 dark:text-white/70 mt-3">
          ...
          <div className="grid grid-cols-2 gap-12">
            <nav aria-label="Protocol Links">
              <h4 className="mb-5 text-[13px] font-bold uppercase tracking-[0.3em] text-black/50 dark:text-white/80">
                Protocol
              </h4>
              <ul className="space-y-4 text-sm uppercase text-black/50 dark:text-white/80">
        ...
        <div className="py-6 text-center">
          <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-black/50 dark:text-white/70">
